...
#
# Script generated by Vivado on Sat Sep 30 20:02:44 +0800 2023
...
#
# Usage        : pll_clock.sh
#                pll_clock.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                pll_clock.sh [-reset_run]
#                pll_clock.sh [-reset_log]
#                pll_clock.sh [-help]
#
...
# script info
echo -e "pll_clock.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./pll_clock.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 20  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot pll_clock xil_defaultlib.pll_clock xil_defaultlib.glbl -log elaborate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="D:/Software/Vivado/Vivado/2023.1/data/xsim"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb pll_clock.wdb xsim.dir libdpi.so)
...
Usage: pll_clock.sh [-step]\n\
Usage: pll_clock.sh [-lib_map_path]\n\
Usage: pll_clock.sh [-reset_run]\n\
Usage: pll_clock.sh [-reset_log]\n\
Usage: pll_clock.sh [-keep_index]\n\
